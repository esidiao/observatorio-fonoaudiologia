...
------------------------
    extrair_censo -> ingestao -> extrair_cpc -> extrair_cnes -> consolidar
...
def verificar_fontes():
    ...
    n, i = _serie_anual("CPC", URL_CPC, ciclo_cpc, ano_limite)
    novidades += n
    indeterminados += i
...
def executar(ano, pular_cnes=False, competencia=None):
    ...
    if not pular_cnes:
        ...
        print("\n[PIPELINE] CNES pulado por pedido; a cobertura ficará nula "
