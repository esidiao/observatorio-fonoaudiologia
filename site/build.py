...
# aritmética de outro.
EIXOS_CORRELACAO = [
    "ICT", "IAF", "ICAF", "ICRE", "CPC_cont", "IDD", "ENADE_cont",
    "vagas_total", "vagas_por_100k", "pct_ead", "HHI_mantenedora",
    "cobertura_municipal", "taxa_conclusao", "pct_doc_doutores",
    "pct_rede_publica", "populacao",
]
...
COMPONENTES_INDICE = [
    ...
    {"key": "IAF", "peso": 25, "rotulo": "Adequação formativa"},
    {"key": "ICAF", "peso": 20, "rotulo": "Cobertura — força de trabalho"},
    {"key": "ICRE", "peso": 15, "rotulo": "Cobertura — rede especializada"},
    {"key": "vagas_por_100k", "peso": 15, "rotulo": "Densidade de vagas"},
]
...
def regressoes(ufs):
    ...
    if m:
        m["pergunta"] = ("A presença de fonoaudiólogos no SUS acompanha a "
...
def escrever_pwa(saida, panorama):
    ...
    versao = f"fono-{panorama.get('ano_censo')}-{resumo.hexdigest()[:12]}"
